...
void CrearLetrasyFiguras()
{
	...
	GLfloat vertices_trianguloverde_oscuro[] = {
		//X			Y			Z			R		G		B
	...
	MeshColor* trianguloverde_oscuro = new MeshColor();
	trianguloverde_oscuro->CreateMeshColor(vertices_trianguloverde_oscuro, 18);
	meshColorList.push_back(trianguloverde_oscuro);    // --------------- [5]
...
int main()
{
	...
	while (!mainWindow.getShouldClose())
	{
		...
		//Cuadrado Verde Izquierda Arriba
		model = glm::mat4(1.0);
		...
		//Triangulo azul
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.0f, 1.44f, -4.0f));
		model = glm::scale(model, glm::vec3(1.2f, 0.5f, 0.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));//FALSE ES PARA QUE NO SEA TRANSPUESTA y se envían al shader como variables de tipo uniform
		meshColorList[2]->RenderMeshColor();

		//Triangulo verde oscuro izquierda
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-1.4f, -0.35f, -4.0f));
		model = glm::scale(model, glm::vec3(0.3f, 0.3f, 0.3f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));//FALSE ES PARA QUE NO SEA TRANSPUESTA y se envían al shader como variables de tipo uniform
		meshColorList[5]->RenderMeshColor();

		//Triangulo verde oscuro derecha
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(1.4f, -0.35f, -4.0f));
		model = glm::scale(model, glm::vec3(0.3f, 0.3f, 0.3f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));//FALSE ES PARA QUE NO SEA TRANSPUESTA y se envían al shader como variables de tipo uniform
		...
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-1.4f, -0.8f, -4.0f));
		model = glm::scale(model, glm::vec3(0.3f, 0.3f, 0.3f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));//FALSE ES PARA QUE NO SEA TRANSPUESTA y se envían al shader como variables de tipo uniform
