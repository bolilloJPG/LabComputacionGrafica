...
int main()
{
	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		model = glm::scale(model, glm::vec3(5.5f, 2.0f, 5.5f));
		...
		// ================================================ se comienza con las llantas ============================================= 
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(3.0f, -2.5f, -0.8f));
		...
		model = glm::translate(model, glm::vec3(-3.0f, -2.5f, -0.8f));
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getRueda2()), glm::vec3(0.0f, 1.0f, 0.0f));   //Giro 2
		model = glm::scale(model, glm::vec3(1.5f, 1.5f, 1.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
		...
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(3.0f, -2.5f, -6.8f));
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getRueda3()), glm::vec3(0.0f, 1.0f, 0.0f));   //Giro 3
		model = glm::scale(model, glm::vec3(1.5f, 1.5f, 1.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
		...
		model = glm::translate(model, glm::vec3(-3.0f, -2.5f, -6.8f));
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getRueda4()), glm::vec3(0.0f, 1.0f, 0.0f));   //Giro 4
		model = glm::scale(model, glm::vec3(1.5f, 1.5f, 1.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
		...
		//CREANDO LA ARTICULACIÓN   // Se hace el rotate antes del translate para mantener el centro 
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion1()), glm::vec3(0.0f, 0.0f, 1.0f));   //Para hacer el giro
		...
		// =======================
		// ESFERA AL FINAL DEL BRAZO 3
		// =======================
		model = modelaux;   // volvemos al CENTRO del brazo 3, sin escala

		// avanzar del centro a la punta
		model = glm::translate(model, glm::vec3(0.0f, 2.5f, 0.0f));
		...
		/* -------------------------------------------------------------------- Canasta  --------------------------------------------------- */
		model = modelaux;   // partir desde la última articulación
