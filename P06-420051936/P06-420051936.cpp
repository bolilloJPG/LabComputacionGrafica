...
// average normals
	GLfloat cubo_vertices[] = {
		// front
		//x		y		z		S		T			NX		NY		NZ
		-0.5f, -0.5f,  0.5f,	0.34f,  0.51f,		0.0f,	0.0f,	-1.0f,	//0  abajo izquierda
		0.5f, -0.5f,  0.5f,		0.65f,	0.51f,		0.0f,	0.0f,	-1.0f,	//1  abajo derecha
		0.5f,  0.5f,  0.5f,		0.65f,	0.74f,		0.0f,	0.0f,	-1.0f,	//2  arriba derecha
		-0.5f,  0.5f,  0.5f,	0.34f,	0.74f,		0.0f,	0.0f,	-1.0f,	//3  arriba izquierda
		// right
		//x		y		z		S		T
...
int main()
{
	...
	dadoTexture = Texture("Textures/intensamente_optimizado.tga");
	...
	//Ejercicio Parte 2 carga modelo
	Dado_M = Model();
	Dado_M.LoadModel("Models/dado_intensamente_texturizado_optimizado.obj");

	// Reporte Práctica | Ejercicio 2 y 3 
	Carro_M = Model();
	Carro_M.LoadModel("Models/coche_texturizado.obj");
	...
	while (!mainWindow.getShouldClose())
	{
		...
		/* ============================================================= Dado usando OpenGL y coordenadas================================================================== */
		...
		//Ejercicio 3:Texturizar la cara del personaje de la imagen tipo cars en el parabrisas (ojos) y detalles en cofre y parrilla de su propio modelo de coche
