...
// average normals
	GLfloat cubo_vertices[] = {
		// front
		//x		y		z		S		T			NX		NY		NZ
		-0.5f, -0.5f,  0.5f,	0.76f,  0.34f,		0.0f,	0.0f,	-1.0f,	//0  abajo izquierda
		0.5f, -0.5f,  0.5f,		1.0f,	0.34f,		0.0f,	0.0f,	-1.0f,	//1  abajo derecha
		0.5f,  0.5f,  0.5f,		1.0f,	0.65f,		0.0f,	0.0f,	-1.0f,	//2  arriba derecha
		-0.5f,  0.5f,  0.5f,	0.76f,	0.65f,		0.0f,	0.0f,	-1.0f,	//3  arriba izquierda
		// right
		//x		y		z		S		T
		...
		// left
		//x		y		z		S		T
		-0.5f, -0.5f,  -0.5f,	0.5f,  0.34f,		1.0f,	0.0f,	0.0f,  //abajo izquierda
...
int main()
{
	...
	dadoTexture = Texture("Textures/dado_animales_optimizado.tga");
